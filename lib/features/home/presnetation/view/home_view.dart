      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            MySizedBox.height32,
            CustomTextType(
              type: S.of(context).popularHotels,
              onTap: () =>
                  context.navigateTo(routeName: Routes.popularHotelsViewRoute),
            ),
            MySizedBox.height16,
            const CustomHotelItemListView(),
            MySizedBox.height32,
            CustomTextType(
              type: S.of(context).tourismServices,
              onTap: () => context.navigateTo(
                  routeName: Routes.tourismServicesViewRoute),
            ),
            MySizedBox.height16,
